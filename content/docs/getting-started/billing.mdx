...
5. Create your products in Polar
   ...
   These must be created in the Polar dashboard. Changes to them be mirrored in `./convex/user/subscription.ts`.

You'll want to perform the setup on [sandbox.polar.sh](https://sandbox.polar.sh/) for development and [polar.sh](https://polar.sh/) for production.
