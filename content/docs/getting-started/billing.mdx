...
**IMPORTANT**: You'll want to perform the setup on [sandbox.polar.sh](https://sandbox.polar.sh/) for development and [polar.sh](https://polar.sh/) for production. Use the sandbox setup for
development.
